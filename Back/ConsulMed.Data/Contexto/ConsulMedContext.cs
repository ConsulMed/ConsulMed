...
namespace ConsulMed.Data.Contexto;

public partial class ConsulMedContext : DbContext
{
    private readonly IConfiguration _configuration;
    public ConsulMedContext()
    {
    }

    public ConsulMedContext(
        DbContextOptions<ConsulMedContext> options,
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdHospital).HasName("PK__Hospital__AF70C2B2501BDF74");
